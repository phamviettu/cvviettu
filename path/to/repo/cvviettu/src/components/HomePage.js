        ...
        return (
            <div className="container">
                    <div className="row container_info">
                        <div className="col-sm-3 container_info_avata">
                        ...
                        <div className="col-sm-9 container_info_content ">
                    ...
                    <div className="row container_skill">
                        <div className = "main_title mt-5 col-sm-12">KĨ NĂNG</div>
                        <div className=" container_skill_c1 mt-5">
                            
                        </div>
                        <div className=" container_skill_c2 mt-5">
